...
<section class="wrapper-box" style="max-width: 1400px; margin: 0px auto; background: #fff; box-shadow: 0px 0px 10px rgb(0 0 0 / 20%);">
    <div>
        ...
        <div class="text-black opacity-75 mt-2 mx-3">
            <h6>
                ...
                <span class="text-dark opacity-75">
                    &nbsp; / &nbsp;<a href="index.php" class="text-decoration-none text-dark opacity-75"> Home </a> &nbsp; / &nbsp;Privacy
                </span>
            </h6>
        </div>
        ...
        <div class="container-fluid">
            ...
            <br>
            <h6>نشكركم على مراجعة وثيقة الخصوصية الشخصية على موقع <a href="index.php" class="text-decoration-none">AlmallStore</a>  ويسعدنا إخباركم أن الموقع على دراية كاملة بمدى حساسية موضوع السرية في تعاملاته على الإنترنت وملتزم بحماية الخصوصية الشخصية ، الغرض من وثيقة الخصوصية هذه هو إظهار المتجر لزواره منهجه العام في جمع واستخدام ونشر معلومات المستخدم من خلال متجرنا.</h6>
            <br>
            <br>
            <br>
            <br>
