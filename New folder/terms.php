    ...
    <div>
        ...
        <div class="container-fluid">
            ...
            <h6>
                ...
                1- بما أن جميع المنتجات إلكترونية ويتم استخدامها مرة واحدة في الحساب ، فلا يتم إرجاع المنتجات أو استبدالها بعد الدفع والاستلام.
                <br>
                <br>
                2- الموقع غير مسؤول عن أي مشاكل فنية في جهاز العميل أو حدوث خطأ برمجي أو ما شابه ذلك ، يجب على العميل التحقق من متطلبات اللعبة قبل شرائها.
                <br>
                <br>
                3- تنتهي مسؤولية الموقع عند تفعيل الكود وتفعيله في الحساب.
                <br>
                <br>
                4- يمنح العميل ضمانًا على اللعبة مدى الحياة.
                <br>
                <br>
                5- يجب على العميل قراءة التفاصيل الخاصة بكل منتج جيداً والتأكد من مطابقتها لطلبه ، فلا يمكن إرجاع أو استبدال منتج بأي شكل من الأشكال بعد إرساله.
                <br>
                <br>
                6- الأسعار قابلة للتغيير في أي لحظة دون إشعار مسبق.
                <br>
                <br>
                7- في حالة وجود مشكلة في الكود أو تفعيل اللعبة أو رمز خاطئ ، يرجى إبلاغنا خلال 14 يومًا من التسليم ، فالموقع غير مسؤول عن تأخير العميل في استرداد المنتج في حسابه.
                <br>
                <br>
                8- عند وجود خطأ في الكود يجب على العميل الانتظار لمدة 24 - 72 ساعة حتى يتم حل المشكلة.
                <br>
                <br>
                9- الموقع غير مسؤول عن مشاركة العميل للرموز أو ما شابه ذلك مع طرف آخر.
                <br>
                <br>
                10- يحق للموقع إعادة المبلغ للعميل إذا كانت عملية السداد مشبوهة وفقاً لطبيعة عمل الموقع دون إبداء سبب للعميل.
                <br>
            </h6>
